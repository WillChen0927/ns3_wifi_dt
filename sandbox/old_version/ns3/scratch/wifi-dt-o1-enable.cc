...
std::string url = "https://192.168.8.6:30780/dcae-ves-collector/eventListener/v7";
...
std::string createPNFVesEvent() {
    ...
    // Create pnfRegistration
    cJSON *pnfRegistrationFields = cJSON_CreateObject();
    cJSON_AddStringToObject(pnfRegistrationFields, "pnfRegistrationFieldsVersion", "2.1");
    cJSON_AddStringToObject(pnfRegistrationFields, "lastServiceDate", "2025-01-01");
    cJSON_AddStringToObject(pnfRegistrationFields, "macAddress", "00:00:00:00:00:00");
    cJSON_AddStringToObject(pnfRegistrationFields, "manufactureDate", "2025-01-01");
    cJSON_AddStringToObject(pnfRegistrationFields, "modelNumber", "ns3-wifi");
    cJSON_AddStringToObject(pnfRegistrationFields, "oamV4IpAddress", "192.168.8.98");
    cJSON_AddStringToObject(pnfRegistrationFields, "seriaNumber", "ns3-wifi-192.168.8.98");
    cJSON_AddStringToObject(pnfRegistrationFields, "softwareVersion", "2.3.5");
    cJSON_AddStringToObject(pnfRegistrationFields, "unitFamily", "ns-3");
    cJSON_AddStringToObject(pnfRegistrationFields, "unitType", "ns3-wifi");
    cJSON_AddStringToObject(pnfRegistrationFields, "vendorName", "ns-3");
    
    cJSON *additionalFields = cJSON_CreateObject();
    cJSON_AddStringToObject(additionalFields, "oamPort", "1830");
