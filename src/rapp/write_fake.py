...
def write_in_sta(sta_name, ssid, radio_band, ap_name, rx_bytes, tx_bytes, input_time):
    ...
    point = (
        ...
        .tag("SSID", ssid)
        .field("RadioBand", radio_band)
        .field("AP_Name", ap_name)
...
write_in_ap("BMW_1F_AP01", "5GHz", "36", "95%", "2%", "1%", "2%", "100 kb/s", "200 kb/s", "2025-02-27T16:41:00Z")
write_in_ap("BMW_1F_AP01", "2.4GHz", "1", "90%", "5%", "3%", "2%", "150 kb/s", "250 kb/s", "2025-02-27T16:42:00Z")
write_in_ap("BMW_1F_AP02", "5GHz", "40", "92%", "3%", "2%", "3%", "120 kb/s", "220 kb/s", "2025-02-27T16:43:00Z")

write_in_sta("STA1", "bmwlab-peap", "5GHz", "BMW_1F_AP01", "500 kb/s", "600 kb/s", "2025-02-27T16:41:00Z")
write_in_sta("STA2", "bmwlab-peap", "2.4GHz", "BMW_1F_AP01", "550 kb/s", "650 kb/s", "2025-02-27T16:42:00Z")
write_in_sta("STA3", "bmwlab-peap", "5GHz", "BMW_1F_AP02", "520 kb/s", "620 kb/s", "2025-02-27T16:43:00Z")
